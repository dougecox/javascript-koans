...
var isPrime = function(value) {
  ...
  it("should find the largest prime factor of a composite number", function () {
    var composite = function(value) {
      for (var value; value > 0; value--) {
  ...
  expect(9973).toBe(composite(10000));


  it("should find the largest palindrome made from the product of two 3 digit numbers", function () {
    var isPalindrome = function(value) {
      var num = value;
      return ( value === parseInt(num.toString().split("").reverse().join("")); )
    }

    var largestPalindromeProdofTwoThreeDigitNum = function( number1, number2 ) {
      var largestNum;
      var num1 
    }
